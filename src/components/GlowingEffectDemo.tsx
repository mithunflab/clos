  ...
  return (
    <ul className="grid grid-cols-1 grid-rows-none gap-4 md:grid-cols-12 md:grid-rows-3 lg:gap-4 xl:max-h-[34rem] xl:grid-rows-2">
      ...
      <GridItem
        ...
        description="Smart defaults and AI-powered suggestions make setup a breeze."
      />
      <GridItem
      ...
      <GridItem
        ...
        description="Get intelligent recommendations and automated optimizations."
      />
      <GridItem
        area="md:[grid-area:3/1/4/13] xl:[grid-area:2/8/3/13]"
        icon={<Search className="h-4 w-4" />}
        title="Real-time Analytics"
        description="Monitor performance and get actionable insights in real-time."
      />
    </ul>
  );
}
